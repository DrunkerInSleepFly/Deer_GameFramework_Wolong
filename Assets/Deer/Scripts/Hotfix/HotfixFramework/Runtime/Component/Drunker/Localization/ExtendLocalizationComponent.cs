...
[AddComponentMenu("Game Framework/ExtendLocalization")]
public sealed partial class ExtendLocalizationComponent : GameFrameworkComponent
{
    ...
    [SerializeField]
    private FontGroup[] m_FontGroups = null;
    ...
    {
        return m_LocalizationManager.GetString(key).Replace("/n", "\n");
    }
    ...
    {
        return m_LocalizationManager.GetString(key, arg).Replace("/n", "\n"); ;
    }
    ...
    {
        return m_LocalizationManager.GetString(key, arg1, arg2).Replace("/n", "\n"); ;
    }
    ...
    {
        return m_LocalizationManager.GetString(key, arg1, arg2, arg3).Replace("/n", "\n"); ;
    }
    ...
    {
        return m_LocalizationManager.GetString(key, arg1, arg2, arg3, arg4).Replace("/n", "\n");
    }
    ...
    {
        return m_LocalizationManager.GetString(key, arg1, arg2, arg3, arg4, arg5).Replace("/n", "\n");
    }
    ...
    {
        return m_LocalizationManager.GetString(key, arg1, arg2, arg3, arg4, arg5, arg6).Replace("/n", "\n");
    }
    ...
    {
        return m_LocalizationManager.GetString(key, arg1, arg2, arg3, arg4, arg5, arg6, arg7).Replace("/n", "\n");
    }
    ...
    {
        return m_LocalizationManager.GetString(key, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8).Replace("/n", "\n");
    }
    ...
    {
        return m_LocalizationManager.GetString(key, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9).Replace("/n", "\n");
    }
    ...
    {
        return m_LocalizationManager.GetString(key, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9, arg10).Replace("/n", "\n");
    }
    ...
    {
        return m_LocalizationManager.GetString(key, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9, arg10, arg11).Replace("/n", "\n");
    }
    ...
    {
        return m_LocalizationManager.GetString(key, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9, arg10, arg11, arg12).Replace("/n", "\n");
    }
    ...
    {
        return m_LocalizationManager.GetString(key, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9, arg10, arg11, arg12, arg13).Replace("/n", "\n");
    }
    ...
    {
        return m_LocalizationManager.GetString(key, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9, arg10, arg11, arg12, arg13, arg14).Replace("/n", "\n");
    }
    ...
    {
        return m_LocalizationManager.GetString(key, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9, arg10, arg11, arg12, arg13, arg14, arg15).Replace("/n", "\n");
    }
    ...
    {
        return m_LocalizationManager.GetString(key, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9, arg10, arg11, arg12, arg13, arg14, arg15, arg16).Replace("/n", "\n");
    }
    ...
    private TMP_FontAsset m_MainFont;

    public TMP_FontAsset GetFont(string fontName)
    {
        for (int i = 0; i < m_FontGroups.Length; i++)
        {
            if (fontName.Equals(m_FontGroups[i].Name))
            {
                return m_FontGroups[i].Font;
            }
        }
        return null;
    }

    public TMP_FontAsset SetMainFont(string fontName)
    {
        for (int i = 0; i < m_FontGroups.Length; i++)
        {
            if (fontName == m_FontGroups[i].Name)
            {
                m_MainFont = m_FontGroups[i].Font;
                break;
            }
        }
        return m_MainFont;
    ...
    public TMP_FontAsset SetMainFont(FontAsset fontAsset)
    {
        if (fontAsset == null || fontAsset.Font == null)
            return null;
        m_MainFont = fontAsset.Font;
        return m_MainFont;
    }

    public TMP_FontAsset SetMainFont(TMP_FontAsset font)
    {
        m_MainFont = font;
        if (font != null)
            return m_MainFont;
    ...
    public void SetTextString(TextMeshProUGUI text, string key, bool isUseMainFont, params object[] args)
    {
        text.text = string.Format(GetString(key), args);
        if (isUseMainFont && m_MainFont != null)
        {
            text.font = m_MainFont;
        }
    }
    public void SetTextString(TextMeshProUGUI text, string key, string fontName, params object[] args)
    {
        text.text = string.Format(GetString(key), args);
        ...
        TMP_FontAsset setFont = GetFont(fontName);
        if (setFont != null)
        {
            text.font = setFont;
        }
    }
    public void SetTextString(TextMeshProUGUI text, string key, params object[] args)
    {
        SetTextString(text, key, false, args);
    }
    public void SetTextString(TextMeshProUGUI text, string key, TMP_FontAsset font, params object[] args)
    {
        text.text = string.Format(GetString(key), args);
